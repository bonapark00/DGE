...
BASE_DIR="${1:-/data/users/jaeyeonpark/DGE-outputs/measure-time/wo-MaskUpdate/iter1/20}"
BASE_DIR="${1:-/data/users/jaeyeonpark/DGE-outputs/camera-selection/w-MaskUpdate/iter1/lambda_d5.0/lens/in2n-GSEditor/face/25}"
...
for eval_file in "${EVAL_FILES[@]}"; do
    ...
    # CLIP_F (scaled): 100.625  (value is 3rd field: CLIP_F, (scaled):, value)
    f_scaled=$(grep -E "^CLIP_F \(scaled\):" "$eval_file" | awk '{print $3}' || echo "")
    # CLIP Score: 28.125
