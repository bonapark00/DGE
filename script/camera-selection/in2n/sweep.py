...
WARP_REFINE_COLOR_FIT_STEPS_DEFAULT = 100  # matches launch_and_metrics.py default

WANDB_PROJECT = "dge-camera-selection"
WANDB_SWEEP_NAME = f"sweep/{DATA_TYPE}/{DATA_NAME}"

# ==========================
# Prompt combinations (same as run_batch_prompts.py); sweep can vary over these via "task" parameter
# ==========================

# STYLE_SOURCE_PROMPT = 편집 전(원본), STYLE_TARGET_PROMPT = 편집 후(목표)
TASKS = [
    # {"name": "smile", "PROMPT": "Make his mouth smile", "SEG_PROMPT": "face of the man",
    #  "TARGET_PROMPT": "Smiling mouth of the man", "STYLE_SOURCE_PROMPT": "A man without smiling",
    #  "STYLE_TARGET_PROMPT": "A Man with smiling"},
    # {"name": "mustache", "PROMPT": "Give him a mustache", "SEG_PROMPT": "face of the man",
    #  "TARGET_PROMPT": "Mustache of the man", "STYLE_SOURCE_PROMPT": "A man without mustache",
    #  "STYLE_TARGET_PROMPT": "A Man with mustache"},
    {"name": "leather_jacket", "PROMPT": "Change the fleece jacket into a leather jacket",
     ...
     "STYLE_SOURCE_PROMPT": "A man with a fleece jacket", "STYLE_TARGET_PROMPT": "A man with a leather jacket"},
    # {"name": "mondigliani", "PROMPT": "Turn him into a Mondigliani painting", "SEG_PROMPT": "man",
    #  "TARGET_PROMPT": "man", "STYLE_SOURCE_PROMPT": "A real photo of a man",
    #  "STYLE_TARGET_PROMPT": "A Mondigliani painting of a man"},
    # {"name": "pixar", "PROMPT": "Turn the man into a stylized 3D Pixar-like character.", "SEG_PROMPT": "man",
    #  "TARGET_PROMPT": "man", "STYLE_SOURCE_PROMPT": "A real photo of a man",
    #  "STYLE_TARGET_PROMPT": "A 3D Pixar-like man"},
    # {"name": "clown", "PROMPT": "Turn the man into a clown.", "SEG_PROMPT": "man",
    #  "TARGET_PROMPT": "clown", "STYLE_SOURCE_PROMPT": "man", "STYLE_TARGET_PROMPT": "clown"},
]
...
SWEEP_CONFIG = {
    ...
    "parameters": {
        ...
        # },
        # Warp-refine color fitting steps (anchor 색만 맞추는 반복 횟수)
        "warp_refine_color_fit_steps": {
            "values": [50, 100, 150],
        },
