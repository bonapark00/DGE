...
DATA_NAME = "garden"
DATA_TYPE = "mip-360"
PROMPT = "Turn the vase into red"
SEG_PROMPT = "vase"
MMR_SEG_PROMPT = "vase"  # for text-based segmentation
TARGET_PROMPT = "A red vase"

DATA_SOURCE = f"/data/users/jaeyeonpark/dataset/{DATA_TYPE}/{DATA_NAME}/"
GS_SOURCE = f"/data/users/jaeyeonpark/3dgs-trained/3dgs-orig/{DATA_NAME}/point_cloud/iteration_30000/point_cloud.ply"
LAMBDA_D = "0.0"
