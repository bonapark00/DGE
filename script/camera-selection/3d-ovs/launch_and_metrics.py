...
PROMPT = "Make the bear wear pants"
PROMPT = "Make the bear wear gloves on his hands" # 실패
PROMPT = "Make the bear wear scarf" # 실패
PROMPT = "Make the color of the pooh look like rainbow"
...
SEG_PROMPT = "red t-shirt"
SEG_PROMPT = "t-shirt"
SEG_PROMPT = "teddy bear"
SEG_PROMPT = "red t-shirt of the pooh"
...
TARGET_PROMPT = "gloves"
TARGET_PROMPT = "scarf"
TARGET_PROMPT = "leathzer jacket"
TARGET_PROMPT = "pooh"
...
DATA_SOURCE = f"/working/style-transfer/DGE-camera-selection/output/orbit_colmap_info"
...
MAX_VIEW_NUM = "25" # 학습에 쓰는 뷰 수 상한  == editing view + CLIP-loss view
MAX_EDIT_VIEW_NUM = "20" # 5의 배수여야함
CAMERA_UPDATE_PER_STEP = "1500"
MASK_UPDATE_AT_STEP = "600" # -1: wo-MaskUpdate, 400: w-MaskUpdate
MASK_UPDATE_VIEW_NUM = "5" ## MAX_VIEW_NUM - MAX_EDIT_VIEW_NUM 보다는 "작야야함". 
...
GT_DIR = ORIGIN_RENDER_DIR  # Use origin renders as GT for metrics
...
STYLE_SOURCE_PROMPT = SEG_PROMPT  # 편집 전/원본
...
def run_single_iteration(run_num: int, total_runs: int, log_file: Optional[Path] = None) -> Tuple[bool, str]:
    ...
    # Step 2.5: Ensure origin renders exist (for metrics GT)
