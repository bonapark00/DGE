...
RENDER_DIR="/data/users/jaeyeonpark/DGE-outputs/camera-selection/wo-MaskUpdate/iter1/lambda_d10.0/random/25/Turn_the_man_into_a_clown@20251110-203409"
RENDER_DIR="${RENDER_DIR}/save/it1500-test/" # e.g., /working/style-transfer/DGE/outputs/.../save/render_it1500-val
