...
# Training config
CONFIG="configs/dge_measure-time.yaml"                 # or configs/dge_view5.yaml
GPU="2"
MAX_STEPS="1500"
...
SEG_PROMPT="man"         # e.g., "man"
# TARGET_PROMPT="clown"      # e.g., "clown"
MASK_THRES="0.6"

# Output discovery and metrics
EXP_ROOT_DIR="/data/users/jaeyeonpark/DGE-outputs"   # must match YAML exp_root_dir
NAME="measure-time/wo-MaskUpdate/iter1/"                                            # must match YAML name
