...
# Batch settings
NUM_RUNS = 10  # Number of times to run launch + metrics
...
# EDIT_VIEW_SELECTION_STRATEGY = "manual-20"  # row, quadrant, manual-20, manual-15, random
CAMERA_UPDATE_PER_STEP = "1500" # 500: iter3, 1500: iter1
# MASK_UPDATE_AT_STEP = "-1"
NAME = f"measure-time/wo-MaskUpdate/iter1"
...
# STYLE_TARGET_PROMPT = "A spider man with a mask"  # leave empty "" to disable
...
STYLE_SOURCE_PROMPT = SEG_PROMPT   # 편집 전/원본; default: "a Photo"
